...
/**
 * Aggregate tests for [DataReference] and examples of
 * - [FileDataSource]
 * - [FileDataLoader]
 * - [DataDefinition]
 *
 ...
 * - [DataReference.get]
 * - DataReference's definition lookup
 *
 * Tests for data source or loader should be made separate.
 */
class DataReferenceTest {
    @Test
    fun `initialize and lookup data definitions works correctly`() {
        ...
        assertDoesNotFail {
            ...
            DataReference.registry.size
        }

        assertDoesNotFail {
            val definition = DataReference.get<PlainTextDefinition>()
...
/**
 * Example implementation of [FileDataSource] format.
 *
 ...
 */
class IniDataSource(override val path: String) : FileDataSource {
...
/**
 * Example implementation of [DataDefinition].
 *
 * In this case, the definition provides a lookup of value.
 */
class PlainTextDefinition(private val input: Map<String, Int>) : DataDefinition {
